...
extension CoenttbWebAccount.Client {
    ...
    ) -> CoenttbWebAccount.Client<User> {
        
        return CoenttbWebAccount.Client<User>(
            create: {
                email,
                password in
                do {
            ...
            emailChange: .init(
                request: { newEmail in
                    ...
                    do {
                        ...
                        else { throw CoenttbWebAccount.Client<User>.RequestEmailChangeError.unauthorized }
                        ...
                        guard let newEmail
                        else { throw CoenttbWebAccount.Client<User>.RequestEmailChangeError.emailIsNil }
