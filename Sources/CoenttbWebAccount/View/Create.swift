...
public enum Create: HTML {
    case request(Create.Request)
    case requestReceivedConfirmationPage(Create.RequestReceivedConfirmationPage)
    case verify(Create.Verify)
    ...
    public struct Request: HTML {
        ...
        public var body: some HTML {
            PageModule(theme: .login) {
                form {
                    VStack {
                        Input.default(CoenttbWebAccount.API.Create.Request.CodingKeys.email)
                            .type(.email)
                            .placeholder(String.email.description)
                            .focusOnPageLoad()
                        
                        Input.default(CoenttbWebAccount.API.Create.Request.CodingKeys.password)
                            .type(.password)
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', async function(event) {
                    ...
                    const email = formData.get('\(CoenttbWebAccount.API.Create.Request.CodingKeys.email.rawValue)');
                    const password = formData.get('\(CoenttbWebAccount.API.Create.Request.CodingKeys.password.rawValue)');
                    ...
                    try {
                        const response = await fetch(form.action, {
                            ...
                            body: new URLSearchParams({
                                 \(CoenttbWebAccount.API.Create.Request.CodingKeys.email.rawValue): email,
                                 \(CoenttbWebAccount.API.Create.Request.CodingKeys.password.rawValue): password
                            }).toString()
                        });
