...
public struct ConfirmAccess<CodingKey: RawRepresentable>: HTML where CodingKey.RawValue == String {
    ...
    public init(
        codingKey: CodingKey = CoenttbWebAccount.API.EmailChange.Reauthorization.CodingKeys.password,
...
@MainActor let confirmAccess: some HTML = ConfirmAccess(
    codingKey: CoenttbWebAccount.API.Create.Request.CodingKeys.password,
