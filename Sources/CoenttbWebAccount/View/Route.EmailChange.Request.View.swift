...
extension Route.EmailChange.Request {
    struct View: HTML {
        ...
        private static let pagemodule_request_email_change_id: String = "pagemodule_request_email_change_id"
        private static let form_id: String = "form-request-email-change"
        ...
        public var body: some HTML {
            PageModule(theme: .login) {
                VStack {
                    ...
                    form {
                        VStack {
                            Input.default(CoenttbWebAccount.API.EmailChange.Request.CodingKeys.newEmail)
                                .type(.email)
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', async function(event) {
                    ...
                    const newEmail = formData.get('\#(CoenttbWebAccount.API.EmailChange.Request.CodingKeys.newEmail.rawValue)');
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            pageModule.outerHTML = `\#(html: Route.EmailChange.Request.View.ReceiptConfirmation(homeHref: self.homeHref, primaryColor: self.primaryColor))`;
                        } else {
                            throw new Error(data.reason || '\#(TranslatedString(
                                dutch: "Verzoek om e-mailadres te wijzigen mislukt",
                                english: "Email change request failed"
...
extension Route.EmailChange.Request.View {
    struct ReceiptConfirmation: HTML {
        let homeHref: URL
        let primaryColor: HTMLColor
